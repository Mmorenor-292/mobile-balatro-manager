...
function ModsScreen({ state, query, setQuery, filter, setFilter, onViewHistory }) {
  ...
  const updatingAll = operationActive && state.operation.kind === "update-all";
  const cleaning = operationActive && state.operation.kind === "cleanup";
  const askUpdateAll = () => {
