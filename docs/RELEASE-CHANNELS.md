...
| --- | --- | --- | --- | --- |
| Beta | `cl.mauricio.balatromods.beta` | `2.0.1-beta` | `Mobile-Mod-Manager-Public-vNext-beta.apk` / `.aab` | Side-by-side acceptance testing |
| Production candidate | `cl.mauricio.balatromods` | `2.0.1` | `Mobile-Mod-Manager-Public-vNext-release.apk` / `.aab` | Stable release candidate |
| Debug | `cl.mauricio.balatromods` | `2.0.1` | `Mobile-Mod-Manager-Public-vNext-debug.apk` | Local development only |
