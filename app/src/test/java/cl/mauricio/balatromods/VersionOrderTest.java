...
public class VersionOrderTest {
    ...
    public void identifiesNewerNumericAndBuildVersions() {
        ...
        assertTrue(VersionOrder.isNewer("3.8.1-0731b", "3.8.1-0724a"));
        assertTrue(VersionOrder.compare("3.8.1-0724a", "3.8.1-0731b") < 0);
    }
    ...
    public void neverDowngradesOrGuessesBranchNames() {
        ...
        assertTrue(VersionOrder.isSourceRevision("3a9be1c"));
        assertFalse(VersionOrder.isSourceRevision("3.8.1-0731b"));
    }
}
